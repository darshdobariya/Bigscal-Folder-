...
public class PDFViewerAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("urlPdf");
    ...
    private void initializePDFView() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(getApplicationContext(), "Fail to get PDF url.", Toast.LENGTH_SHORT).show();
            }
        });
    }
